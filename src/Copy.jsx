export const COPY = {
  es: {
    ...
    hero: {
      ...
      subtitleTemplate:
        "Pasadías, hospedaje, restaurante y eventos en medio del verde de la Sierra Nevada. Pasadía desde {price}, con almuerzo incluido.",
    ...
    whatsapp: {
      tooltip: "Escríbenos",
      message: "Hola, vengo desde su página web. Quiero más información sobre Sierra Campestre.",
    },
    langSwitch: "English",
  },
  en: {
    ...
    hero: {
      pill: "Santa Marta, Magdalena",
      subtitleTemplate:
        "Day trips, lodging, restaurant and events surrounded by the green of the Sierra Nevada. Day pass from {price}, lunch included.",
    ...
    whatsapp: {
      ...
      message: "Hi, I come from your website. I'd like more information about Sierra Campestre.",
    },
    langSwitch: "Español",
  },
};
